...
const CartButton = () => {
  ...
  return (
    <Link to="/cart" className="relative inline-flex items-center gap-2 rounded-full border border-black/10 bg-white px-3 py-2 text-sm font-semibold text-gray-800 shadow-sm transition hover:bg-gray-50 hover:border-black/20">
